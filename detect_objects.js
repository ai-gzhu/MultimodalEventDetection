...
const {cv, runVideoDetection} = require("./utils.js");
...
const detectionModelPath = "./ssd_inception_v2_coco_2017_11_17";//	"./mask_rcnn_inception_v2_coco_2018_01_28";

const pbFile = path.resolve(detectionModelPath, "frozen_inference_graph.pb");
const pbtxtFile = path.resolve(
  detectionModelPath,
  "ssd_inception_v2_coco_2017_11_17.pbtxt.txt"
